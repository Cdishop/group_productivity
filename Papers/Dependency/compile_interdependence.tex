...
\hypersetup{unicode=true,
            pdftitle={Opportunities and Recommendations for Structural Interdependence Measures and Indices},
            pdfauthor={Author~\& Author2},
            pdfkeywords={Structural interdependence, task, outcome, initiated, received,
measurement, theory},
            pdfborder={0 0 0},
            breaklinks=true}
...
\abstract{
Structural interdependence, or the resources and workflows as well as
goal and reward systems that connects team members, tasks, and jobs, is
a thriving area in organizational science. Emerging evidence across
multiple fields suggests that interdependence is a fundamental component
to many aspects of workplace functioning. Its operationalization,
though, both with respect to measures in empirical studies and indices
computed across various theories, has yet to receive an integrated
discussion. This paper reflects on how the constructs and ideas subsumed
under structrual interdependence are assessed and indexed to guide
management research in this area. We provide a taxonomy of measurement
devices and indices that fosters the alignment of theory and
measurement, point out discrepancies and assumptions, describe
unanswered questions, and present actionable next steps for research. In
short, our paper begins a conversation about structural interdependence
